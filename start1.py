...
l7 = ["CFB","GET","NULLGET","POST","POSTV2","SPAMMER","GETV2","HTTPFAST","HTTPFASTV2","MIX","MIXV2","BYPASS","BYPASSV2","AMAZONBYPASS","AMAZONBYPASSV2","CFBV2","KILLALL","HTTP_BETA","CFUAM","CFNULL"]
l4 = []
l3 = [""]
to = [""]
ot = [""]
...
def Headers(method):
    header = ""
    if method == "get" or method == "getv2" or method == "socket" or method == "httpfast" or method == "httpfastv2" or method == "mix" or method == "mixv2" or method == "bypass" or method == "bypassv2" or method == "amazonbypass" or method == "amazonbypassv2" or method == "cfbv2" or method == "cfuam":
