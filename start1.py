...
from ssl import SOL_SOCKET, SSLContext, SSLSession, SSLSocket, TLSVersion
...
l7 = ["CFB","GET","NULL","POST","HEAD","POSTV2","SPAMMER","GETV2","HTTPFAST","HTTPFASTV2","BYPASS","BYPASSV2","CFBV2","HTTP_BETA","CFUAM"]
l4 = []
l3 = [""]
to = [""]
ot = [""]
...
Other:
 ...
 Exit
    ...
    if tool == "cfip":
        ...
        print("https://dstat.cc  https://cyber-hub.pw/layer7_home.php ")
        return tools()
    elif tool == "dns":
        return tools()
    elif tool == "check":
